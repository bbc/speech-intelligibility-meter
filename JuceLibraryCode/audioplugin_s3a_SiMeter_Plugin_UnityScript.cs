...
public class audioplugin_s3a_SiMeter_PluginGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_s3a_SiMeter_Plugin"; } }
    public override string Description    { get { return "s3a_SiMeter_Plugin"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
	[DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_s3a_SiMeter_Plugin")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
